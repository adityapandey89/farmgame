...
ini_set('display_errors', 0);     # don't show any errors... to check error replace 0 with 1
error_reporting();                # don't show any errors... to check error replace "" with E_ALL or other warnings
